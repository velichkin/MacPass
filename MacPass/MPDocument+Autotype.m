...
- (NSArray *)autotypContextsForWindowTitle:(NSString *)windowTitle preferredEntry:(KPKEntry *)entry {
  ...
  for(KPKEntry *entry in autotypeEntries) {
    ...
    */
    ...
    if ((titleRange.location != NSNotFound && titleRange.length != 0) || (([windowTitle isEqualToString:@"Window"] || [windowTitle isEqualToString:@"Top Sites"]) && [entry.notes rangeOfString:@"allowEmptyWindowAutoType" options:NSCaseInsensitiveSearch].length != 0)) {
